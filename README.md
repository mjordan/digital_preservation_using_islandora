...
The Islandora PREMIS module aggregates data generated by other Islandora modules and microsrevices and serializes that data consistent with PREMIS version 3 in Turtle RDF. For example, PREMIS RDF that includes some technical metadata and some fixity check events looks like this:
